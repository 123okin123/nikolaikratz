...
type usersnikolaikratzDevnikolaikratzsrctemplatesblogTsx382678564QueryVariables = Exact<{
  slug: Scalars['String'];
}>;


type usersnikolaikratzDevnikolaikratzsrctemplatesblogTsx382678564Query = { readonly markdownRemark: Maybe<(
